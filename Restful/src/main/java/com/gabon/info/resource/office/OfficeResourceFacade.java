...
public interface OfficeResourceFacade<Response, Office> extends ResourceFacade<Response, Office, Long> {
	...
	public Response findByOffice(final @QueryParam(OFFICE) Object office, final @QueryParam(ROWSSTARTIDXANDCOUNT) int... rowStartIdxAndCount);
}