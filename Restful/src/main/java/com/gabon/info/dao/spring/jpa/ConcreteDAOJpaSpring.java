...
@Transactional
@Repository(BEAN_CONCRETE_DAO_JPA_SPRING)
public class ConcreteDAOJpaSpring<E, PK extends Serializable> extends AbstractJpaDaoSupport<E, PK> implements AbstractDAOFactory<E> {	
	
	private static final long serialVersionUID = 8209896436401203107L;
