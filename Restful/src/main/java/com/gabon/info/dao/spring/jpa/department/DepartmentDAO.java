...
import static com.gabon.info.util.RestFulConstants.BEAN_DEPARTMENT_DAO_JPA_SPRING;
...
@Transactional
@Repository(BEAN_DEPARTMENT_DAO_JPA_SPRING)
public class DepartmentDAO extends ConcreteDAOJpaSpring<Department, Long> implements DepartmentDAOFacade<Department> {
