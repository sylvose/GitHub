...
rem ---------------------------------------------------------------------------
rem   Building script for the PortletWithMaven-1.0-SNAPSHOT.war
rem
...
REM ---------------------------------------------------------------------------
REM    PortletWithMaven Project
REM    If you plan to write automated PortletWithMaven regularly then it might be a good idea to install.
REM    This allows you to easily build PortletWithMaven.
REM 
REM
