package com.gabon.info.dao.spring.hibernate.office;

import static com.gabon.info.util.Constants.BEAN_OFFICE_DAO_HIBERNATE_SPRING;
...
@Transactional
@Repository(BEAN_OFFICE_DAO_HIBERNATE_SPRING)
public class OfficeDAO extends ConcreteDAOHibernateSpring<Office, Long> implements OfficeDAOFacade<Office> {
