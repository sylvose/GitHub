...
import static com.gabon.info.util.Constants.BEAN_PROJECTS_DAO_HIBERNATE_SPRING;
...
@Transactional
@Repository(BEAN_PROJECTS_DAO_HIBERNATE_SPRING)
public class ProjectsDAO extends ConcreteDAOHibernateSpring<Projects, Long> implements ProjectsDAOFacade<Projects> {
