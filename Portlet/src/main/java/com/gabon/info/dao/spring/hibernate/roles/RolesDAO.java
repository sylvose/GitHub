package com.gabon.info.dao.spring.hibernate.roles;

import static com.gabon.info.util.Constants.BEAN_ROLES_DAO_HIBERNATE_SPRING;
...
@Transactional
@Repository(BEAN_ROLES_DAO_HIBERNATE_SPRING)
public class RolesDAO extends ConcreteDAOHibernateSpring<Roles, Long> implements RolesDAOFacade<Roles> {
