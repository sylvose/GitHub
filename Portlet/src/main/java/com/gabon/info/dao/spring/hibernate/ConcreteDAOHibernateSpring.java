...
import static com.gabon.info.util.Constants.BEAN_CONCRETE_DAO_HIBERNATE_SPRING;
...
@Transactional
@Repository(BEAN_CONCRETE_DAO_HIBERNATE_SPRING)
public class ConcreteDAOHibernateSpring<E, PK extends Serializable> extends AbstractHibernateDaoSupport<E, PK> implements AbstractDAOFactory<E> {
	...
	public ConcreteDAOHibernateSpring() {
		super(); 
	}
