package com.gabon.info.dao.hibernate.department;
 ...
 * 
 */
public class DepartmentDAO extends ConcreteDAOHibernate<Department> implements DepartmentDAOFacade<Department> {
