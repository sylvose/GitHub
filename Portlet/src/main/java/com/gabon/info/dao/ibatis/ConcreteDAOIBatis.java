 ...
 * 
 */
public class ConcreteDAOIBatis<E> extends AbstractIBatisDAO<E> implements AbstractDAOFactory<E> {		
	
	private static final long serialVersionUID = -7505690593811500695L;

	
	public ConcreteDAOIBatis() {
		super(); 
	}

	public ConcreteDAOIBatis(Class<E> clazz) { 
		super(clazz);
		this.clazz = clazz; 
	}
