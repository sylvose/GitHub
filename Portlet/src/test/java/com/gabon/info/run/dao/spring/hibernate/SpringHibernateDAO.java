package com.gabon.info.run.dao.spring.hibernate;
...
import com.gabon.info.dao.spring.hibernate.department.DepartmentDAOFacade;
import com.gabon.info.dao.spring.hibernate.office.OfficeDAO;
import com.gabon.info.dao.spring.hibernate.office.OfficeDAOFacade;
import com.gabon.info.dao.spring.hibernate.projects.ProjectsDAO;
import com.gabon.info.dao.spring.hibernate.projects.ProjectsDAOFacade;
import com.gabon.info.dao.spring.hibernate.roles.RolesDAO;
import com.gabon.info.dao.spring.hibernate.roles.RolesDAOFacade;
import com.gabon.info.dao.spring.hibernate.users.UsersDAO;
import com.gabon.info.dao.spring.hibernate.users.UsersDAOFacade;
...
public class SpringHibernateDAO implements Constants {

	private static final long serialVersionUID = 7152176377366845848L;
	
	private static final Logger logger = Logger.getLogger(SpringHibernateDAO.class.getName());
	
	
	private static final UsersDAOFacade<Users> usersDAOFacade = new UsersDAO();

	private static final RolesDAOFacade<Roles> rolesDAOFacade = new RolesDAO();
	
	private static final ProjectsDAOFacade<Projects> projectsDAOFacade = new ProjectsDAO();
	
	private static final DepartmentDAOFacade<Department> departmentDAOFacade = new DepartmentDAO();
	
	private static final OfficeDAOFacade<Office> officeDAOFacade = new OfficeDAO();
