package com.gabon.info.run.dao.spring.ibatis;
...
import com.gabon.info.dao.spring.ibatis.department.DepartmentDAOFacade;
import com.gabon.info.dao.spring.ibatis.office.OfficeDAO;
import com.gabon.info.dao.spring.ibatis.office.OfficeDAOFacade;
...
import com.gabon.info.dao.spring.ibatis.roles.RolesDAOFacade;
...
public class SpringIBatisDAO implements Constants {

	private static final long serialVersionUID = 7152176377366845848L;
	
	private static final Logger logger = Logger.getLogger(SpringIBatisDAO.class.getName());
