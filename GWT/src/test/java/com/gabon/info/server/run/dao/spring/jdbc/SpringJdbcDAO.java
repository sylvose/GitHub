package com.gabon.info.server.run.dao.spring.jdbc;
...
import com.gabon.info.server.dao.spring.jdbc.department.DepartmentDAOFacade;
import com.gabon.info.server.dao.spring.jdbc.office.OfficeDAO;
import com.gabon.info.server.dao.spring.jdbc.office.OfficeDAOFacade;
...
import com.gabon.info.server.dao.spring.jdbc.roles.RolesDAOFacade;
...
public class SpringJdbcDAO implements Constants {

	private static final long serialVersionUID = 7152176377366845848L;
	
	
	private static final  Logger logger = Logger.getLogger(SpringJdbcDAO.class.getName());
