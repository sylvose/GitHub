...
CREATE TABLE UQAM.USERS ( 
          ...
          PRIMARY KEY (ID),
		  UNIQUE(NAME, EMAIL),
          CONSTRAINT CST_FK_USERS_OFFICEID FOREIGN KEY (OFFICEID) REFERENCES UQAM.OFFICE(ID) ON DELETE CASCADE,
          CONSTRAINT CST_FK_USERS_DEPARTMENTID FOREIGN KEY (DEPARTMENTID) REFERENCES UQAM.DEPARTMENT(ID) ON DELETE CASCADE
);
...
CREATE TABLE UQAM.USERS_PROJECTS  ( 
      ...
      CONSTRAINT CST_FK_USER_PROJECT_USERSID FOREIGN KEY (USERSID) REFERENCES UQAM.USERS(ID) ON DELETE CASCADE,
      CONSTRAINT CST_FK_USER_PROJECT_PROJECTSID FOREIGN KEY (PROJECTSID) REFERENCES UQAM.PROJECTS(ID) ON DELETE CASCADE
);
