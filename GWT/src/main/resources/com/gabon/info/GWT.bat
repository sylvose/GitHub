...
rem ---------------------------------------------------------------------------
rem   Building script for the GWT-1.0-SNAPSHOT.war
rem
...
REM ---------------------------------------------------------------------------
REM    GWT Project
REM    If you plan to write automated GWT regularly then it might be a good idea to install.
REM    This allows you to easily build GWT.
REM 
REM
