package com.gabon.info.server.util;
...
/*
 * This class Constants provides many constants.
 * 
...
public interface Constants extends Serializable {
	...
	String UPDATING_E = "updating E instance with id: ";
	...
	String SERVICE_FACADE_RPC_SYNC = "ServiceFacadeRPCSync";
	String ASYNC_CALL_BACK_SUCCESS = "success code goes here";
	String ASYNC_CALL_BACK_FAILURE = "failure code goes here";
