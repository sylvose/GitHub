package com.gabon.info.server.model.department;

import static com.gabon.info.server.util.Constants.BEAN_DEPARTMENT;
import static com.gabon.info.server.util.Constants.DEPARTMENT_SEQ;
import static com.gabon.info.server.util.Constants.DEPARTMENT_SEQ_GEN;
import static com.gabon.info.server.util.Constants.Department;
import static com.gabon.info.server.util.Constants.GET_ALL_DEPARTMENT_NAME;
import static com.gabon.info.server.util.Constants.GET_DEPARTMENT_QUERY;
import static com.gabon.info.server.util.Constants.T_DEPARTMENT;
